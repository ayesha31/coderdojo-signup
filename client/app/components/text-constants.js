(function () {
    ...
    function TextConstants(isGirlsDojo, eventDateLong, eventName) {
        var text = {
            title: eventName,
            information: 'The ' + eventName + ' will be run from' + eventDateLong + 'Sessions will run from 4:30pm till 6pm on the Podium level at Bankwest place.',
            activities: [
                'Scratch',
                'Game Maker',
            ...
            acceptedMessage: 'You have successfully signed up for ' + eventName + (isGirlsDojo ? ' ' : ' We will be sending you a calendar invite shortly. ')
